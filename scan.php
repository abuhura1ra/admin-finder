<?php 
echo("\033[1;36;40mPHP Admin Finder\n\n");

$input = readline("\033[1;36;40mTarget site: \n");
$url = $input."/";


$admins = array('admin.php','admin/','admin/login.jsp','administrator/','moderator/','webadmin/','adminarea/','bb-admin/','adminLogin/','admin_area/','panel-administracion/','instadmin/','memberadmin/','administratorlogin/','adm/','admin/account.php','admin/index.php','admin/login.php','admin/admin.php','admin/account.php','joomla/administrator','login.php',
...
foreach($admins as $admin) {
    ...
    if ($headers[0] == 'HTTP/1.1 200 OK') {
        echo "\n\033[1;32;40m[+]".$url.$admin."<--Found\n";
        $op = fopen("found.txt","w");
        fwrite($op,$link);
    } else {
        echo "\n\033[1;31;40m[-] \033[1;35;40m".$url.$admin."<--Not Found\n";
    }
}
